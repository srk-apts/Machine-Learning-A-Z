...
dataset = read.csv('C:/Users/a0687514/Downloads/Desktop/Data Science/Machine Learning A-Z - Udemy/Part 2 - Regression/Section 5 - Multiple Linear Regression/Homework_Solutions/50_Startups.csv')
